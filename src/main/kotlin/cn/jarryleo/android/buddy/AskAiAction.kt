...
private class AskAiChatHolder(
     ...
     * 由 [AskAiAction.showChatDialog] 在构造完 [cn.jarryleo.android.buddy.ui.InsertStringsEditorOpsController]
     * 后调用,内部走 controller 的 [cn.jarryleo.android.buddy.ui.InsertStringsEditorOpsController.runReplaceSelection]
